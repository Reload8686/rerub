...
#ifdef LOAD_RELATIVE
#define MJIT_HEADER_INSTALL_DIR "/include/ruby-3.1.0/aarch64-linux"
#else
#define MJIT_HEADER_INSTALL_DIR "/usr/local/include/ruby-3.1.0/aarch64-linux"
#endif
#define MJIT_MIN_HEADER_NAME "rb_mjit_min_header-3.1.2.h"
